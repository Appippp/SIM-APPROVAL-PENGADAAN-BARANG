...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo e(route('manager-operational.index')); ?>" class="btn btn-danger  "> <i class="fa fa-arrow-left"></i> Kembali</a>
</div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TUGAS AKHIR\SISTEM\revisi\resources\views/pages/approval-surat/manager-operational/show.blade.php ENDPATH**/ ?>