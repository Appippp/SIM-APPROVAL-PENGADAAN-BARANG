...
class DirekturController extends Controller
{
    public function index()
    {
        ...
        return view('pages.approval-surat.direktur.index', compact('nomorSuratTerverfikasi'));
    }
    ...
    public function show($id)
    {
       ...
       return view('pages.approval-surat.direktur.show', compact('nomorSurat', 'barang', 'unit', 'kategori'));
    ...
    public function approveSurat($id)
    {
        ...
        $nomorSurat->update(['direktur_approve' => 'Terverifikasi oleh Direktur']);
